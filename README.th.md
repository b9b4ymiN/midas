...
| “ตลาดรู้เรื่องธุรกิจนี้แล้วหรือยัง” | `compounder-stage-chart` |
| “ผ่านแล้ว — ถ้าจะเก็บ ควรเก็บยังไง” | `compounder-accumulation-plan` |
...
### การเติบโตทบต้น: ทักษะเฉพาะด้านแปดตัว
...
- **[compounder-stage-chart](./skills/compounder/compounder-stage-chart/SKILL.md)** — อ่านราคาหุ้นบนกราฟรายเดือนและรายสัปดาห์ ระบุว่าอยู่ในช่วงไหนมาตั้งแต่เมื่อไร แล้วเอามาไขว้กับช่วงชีวิตของตัวธุรกิจเอง ทำให้กรณีที่ธุรกิจกำลังทบต้นแต่ราคาไม่ไปไหน กลายเป็นคำถามที่ต้องตอบ ไม่ใช่เรื่องบังเอิญ — ไม่มีจุดเข้า จุดตัดขาดทุน หรือราคาเป้าหมาย
- **[compounder-accumulation-plan](./skills/compounder/compounder-accumulation-plan/SKILL.md)** — ทำงานเฉพาะกับบริษัทที่ผ่านการตรวจเรื่องการทบต้นมาแล้ว และตอบว่าราคาวันนี้กำลังคาดหวังอะไรอยู่ แทนที่จะตอบว่าบริษัทควรมีมูลค่าเท่าไร โดยเทียบการเติบโตที่ฝังอยู่ในราคา กับการเติบโตที่ธุรกิจ แสดงให้เห็นแล้วว่าทำได้ ออกมาเป็นโซนราคาสามระดับและแผนแบบมีเงื่อนไข — ไม่มีมูลค่าที่เหมาะสม ไม่มีราคาเป้าหมาย และไม่มีคำสั่งให้ซื้อ
